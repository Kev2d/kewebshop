<?php
       ...
       $published_posts = wp_count_posts('product')->publish;        
        ...
        ?>
                ...
                <div class="more-products__inside-item js-item">
                    <a href="<?= get_permalink($productId); ?>">

                        <div class="more-products__inside-item-thumbnail<?= $postThumbnail ? ' has-thumbnail' : '' ?>">
                        ...
                        <div class="more-products__inside-item-prices">
