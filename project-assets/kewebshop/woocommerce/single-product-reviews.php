	...
	<section class="reviews">
		...
		?>
				<div class="reviews__user-review js-user-review">
					<span class="reviews__user-review-name"><?= $comment->comment_author; ?></span>
        ...
        ?>
          <a href="#" class="reviews__delete-button js-delete-review" data-comment-id="<?= $comment->comment_ID; ?>" data-user-email="<?= $the_user->user_email; ?>"><?= __('Eemalda tagasiside', 'kewebshop'); ?></a>
        <?php endif; ?>
